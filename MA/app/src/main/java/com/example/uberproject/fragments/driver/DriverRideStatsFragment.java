...
public class DriverRideStatsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        bindViews(view);
        // Driver label: "TOTAL EARNED" instead of "TOTAL SPENT"
        if (tvMoneyLabel != null) tvMoneyLabel.setText("TOTAL EARNED");
        if (tvSpendingChartLabel != null) tvSpendingChartLabel.setText("Earnings per Day (RSD)");
        setupDatePickers();
        setupQuickFilters();
        applyLast30Days();
        return view;
    ...
    private void loadStats() {
        ...
        rideApi.getDriverStats(email, selectedFromDate, selectedToDate).enqueue(new Callback<RideStatsResponseDTO>() {
            @Override
