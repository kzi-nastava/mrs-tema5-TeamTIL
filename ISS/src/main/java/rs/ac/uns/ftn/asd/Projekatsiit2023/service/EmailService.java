...
public class EmailService {
    ...
    public void sendResetPasswordEmail(String toEmail, String token) {
        // Za reset password - koristi localhost (bez porta) za deep link u aplikaciji
    ...
    public void sendActivationEmail(String toEmail, String token) {
        // IZMENJENO - koristi localhost (bez porta) za deep link u aplikaciji
        String activationLink = "http://localhost:4200/activate-driver?token=" + token;
